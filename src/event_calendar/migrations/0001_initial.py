    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_end', models.DateTimeField(blank=True, help_text='Leave empty if the event has no specific end time.', verbose_name='Event end date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='event_calendar.event', verbose_name='Related event')),
            ],
        ),
        migrations.CreateModel(
            name='EventInvite',
        ...
        migrations.AddField(
            model_name='event',
            name='cohosts',
            field=models.ManyToManyField(related_name='cohosted_events', through='event_calendar.EventInvite', to='event_calendar.Group', verbose_name='Event co-hosts'),
        ),
        migrations.AddField(
            model_name='event',
            name='host',
